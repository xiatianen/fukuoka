...
(function () {
  ...
  const DAYS = [
    ...
    },
    {
      ...
      returnNote: "今晚動線都在地鐵／步行圈：天神逛街 → 17:00『叙々苑』高級燒肉（早一點開動；想離飯店近也可改薬院・渡辺通『ヤキニク上』）→ 地鐵 1 站到中洲 → Canal City 夜噴泉（19:00 場）→ 一蘭総本店（20:00 演舞）→ 中洲屋台（吃飽當宵夜小酌）→ 步行約 12 分回 COCO Gofukumachi（上呉服町；或地鐵中洲川端→呉服町 1 站）。河畔晚風是 8 月福岡最舒服的時刻。屋台週日部分店休，但 8/7 抵達夜已先吃過一輪，演舞每天都有不受影響。",
      bookLinks: [
      ...
      stops: [
        ...
        {
          id: "d3-jojoen", key: "jojoen", name: "叙々苑 天神岩田屋本店新館 · 高級燒肉晚餐",
          type: "yakiniku", time: "17:00", lat: 33.5890, lng: 130.3969,
          desc: "把原本 8/10 的『叙々苑』高級燒肉移到今晚天神（8/10 改去宮地嶽神社看夜間風鈴點燈、回程太晚）。叙々苑 天神岩田屋本店新館 7F，營業 11:00–22:00（餐點 L.O. 21:00）；和牛燒肉、個室與服務都是名店水準，每人約 ¥10,000–16,000，人氣店務必先線上或電話（092-737-5989）予約。約 17:00 早一點開動，吃完地鐵 1 站到中洲接 Canal City 噴泉與一蘭演舞。",
          arrive: {
            mode: "walk",
            text: "就在天神購物範圍內：岩田屋本店新館 7F，從天神百貨／地下街步行約 3 分直結。",
            legs: [{ seg: "天神→叙々苑（岩田屋本店新館）", line: "步行（天神地下街直結）", type: "徒步", min: 3, fare: 0 }],
            fare: "¥0",
            book: { label: "叙々苑 線上予約", url: "https://booking.resty.jp/webrsv/search/s014005101/28004" }
          },
          cost: { jpy: "高級燒肉 每人約 ¥10,000–16,000（午餐約 ¥4,000 起）", note: "岩田屋本店新館 7F·48 席·有個室；人氣店務必先線上／電話 092-737-5989 予約；原排 8/10、因宮地嶽夜燈移到今晚", book: { label: "叙々苑 天神岩田屋 線上予約", url: "https://booking.resty.jp/webrsv/search/s014005101/28004" } }
        },
        {
