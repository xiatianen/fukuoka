...
(function () {
  ...
  const DAYS = [
    ...
    },
    {
      ...
      summary: "不趕的一天：從飯店出發北上小倉（當日來回、不帶行李），旦過市場、小倉城、有頂棚商店街輕鬆逛吃，傍晚轉八幡上皿倉山看日落與「新日本三大夜景」，看完夜景搭 JR 回福岡、回 COCO 早點休息。",
      ...
      stops: [
        {
          ...
          arrive: {
            mode: "rail",
            text: "10:00 從 COCO 出發（當日來回、不帶行李）：步行 3 分至呉服町站 → 地下鐵（中洲川端轉空港線）至博多 → 博多→小倉新幹線約 16 分。",
