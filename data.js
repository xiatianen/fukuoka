 ...
 *  2026/6/14 第四輪：四晚都住「Cross Life 博多天神」(春吉)、不換房；
 *  北九州(8/8)改當日來回、不過夜。交通(arrive.legs)＋訂票(book)＋
 *  各停點估價(cost)＋總預算(META.budget)同步更新；地圖路徑見 routes.js。
...
(function () {
  ...
  const DAYS = [
    {
      ...
      summary: "晚間 20:00 抵福岡機場，計程車直達 Cross Life 博多天神（春吉、那珂川南岸），落地第一碗拉麵後早早休息——隔天是全程最長的一天。四晚都住這間、不換房。",
      stops: [
        {
        ...
        {
          id: "d1-hotel", key: "nakasu", name: "Cross Life 博多天神",
          type: "hotel", time: "21:30", lat: 33.5878, lng: 130.4066,
          photo: "assets/img/nakasu.jpg",
          desc: "check-in、放行李。這趟四晚都住這間——ORIX 設計旅店 Cross Life 博多天神（春吉、那珂川南岸）：過河即中洲，步行到中洲屋台 4–5 分、一蘭總本店 5–6 分、天神 7–10 分；男女皆有大浴場＋三溫暖（數位藝術）、福岡在地食材自助早餐。四晚不換房、北九州當日來回，行李零搬動。",
          arrive: {
            mode: "taxi",
            text: "國際線航廈無地鐵站，帶行李夜間建議計程車直達；省錢可走免費接駁＋地下鐵。",
            legs: [{ seg: "國際線→Cross Life 博多天神", line: "計程車（GO／DiDi 叫車）", type: "計程車", min: 18, fare: 2600 }],
            fare: "約 ¥2,300–2,800（直達，可多人均攤）",
            freq: "",
            alt: "省錢：免費連絡巴士→地下鐵空港線（福岡空港→中洲川端／天神）約 ¥260（每人），再步行 5–8 分。國際線無地鐵、需先接駁到國內線。",
            book: { label: "福岡市地下鐵 路線・運賃案內", url: "https://subway.city.fukuoka.lg.jp/" }
          },
          cost: { jpy: "約 ¥22,000–36,000／晚（2 人 1 室·旺季）× 4 晚", note: "Cross Life 博多天神；8/7–8/8 暑假週末偏高、建議早訂比價（停車另計 ¥1,700／晚）", book: { label: "Cross Life 博多天神 官方訂房", url: "https://crosslife-hakatatenjin.orixhotelsandresorts.com/" } }
        },
        {
          id: "d1-ichiran", key: "ichiran", name: "中洲覓食（一蘭總本店 / 屋台）",
          type: "food", time: "22:00", lat: 33.5932, lng: 130.4046,
          photo: "assets/img/ichiran.jpg",
          desc: "「落地第一碗」：過那珂川到對岸中洲，川端通商店街、那珂川河畔屋台（週五有開），或 24 小時的一蘭總本店。吃完早點休息。（屋台壓軸雖排在 8/9，今晚先吃一輪當保險。）",
          arrive: {
            mode: "walk",
            text: "從 Cross Life 過那珂川到中洲，徒步約 4–6 分。",
            legs: [{ seg: "Cross Life→中洲（一蘭／屋台）", line: "步行（過春吉橋）", type: "徒步", min: 5, fare: 0 }],
            fare: "¥0"
          },
    ...
    },
    {
      ...
      summary: "不趕的一天：從飯店出發北上小倉（當日來回、不帶行李），旦過市場、小倉城、有頂棚商店街輕鬆逛吃，傍晚轉八幡上皿倉山看日落與「新日本三大夜景」，看完夜景搭 JR 回福岡、回 Cross Life 泡大浴場早點休息。",
      returnNote: "歸途：皿倉山下山 → 八幡駅 → JR 鹿兒島本線回博多約 1 小時（約 ¥860）→ 回 Cross Life 博多天神。山頂比平地涼約 5°C，是 8 月最舒服的避暑點；今天最操，回房泡大浴場早點睡，隔天睡到自然醒。",
      stops: [
        {
          id: "d2-kokura", key: "kokura", name: "小倉 · 北九州市中心",
          type: "shop", time: "12:30", lat: 33.8847, lng: 130.8736,
          photo: "assets/img/kokura.jpg",
          desc: "北九州的門戶城市，輕鬆逛吃半天（當日來回、不帶行李）：旦過市場（百年「北九州的廚房」、在地小吃）、小倉城＋庭園、魚町銀天街等有頂棚商店街（冷氣多、避熱）、リバーウォーク北九州。午餐在旦過或城下町解決。",
          arrive: {
            mode: "rail",
            text: "10:00 從 Cross Life 出發（當日來回、不帶行李）：地下鐵到博多 → 博多→小倉新幹線約 16 分。",
    ...
    },
    {
      ...
      returnNote: "壓軸動線全在步行圈：Canal City → 一蘭総本店（20:00 演舞）→ 中洲屋台 → 過那珂川回 Cross Life 博多天神（春吉，步行幾分鐘）。河畔晚風是 8 月福岡最舒服的時刻。屋台週日部分店休，但 8/7 抵達夜已先吃過一輪，演舞每天都有不受影響。",
      bookLinks: [
        { label: "Cross Life 博多天神 訂房（四晚）", url: "https://crosslife-hakatatenjin.orixhotelsandresorts.com/" }
      ],
      stops: [
        {
          ...
          arrive: {
            mode: "rail",
            text: "悠閒早晨：從 Cross Life（春吉）步行或地下鐵七隈線（天神南）到天神約 7–10 分（想吃早餐可順到博多駅前 DACOMECCA 麵包，8:00 開）。今天不排 teamLab、純室內購物、步調最慢。",
            legs: [{ seg: "Cross Life→天神", line: "步行 或 地下鐵七隈線（天神南）", type: "徒步／地鐵", min: 8, fare: 0 }],
            fare: "¥0–210",
            freq: ""
          },
        ...
        },
        {
          ...
          desc: "清流公園屋台帶宵夜＋那珂川河畔散步，以屋台＋夜河景收尾後過河步行回 Cross Life。週日部分屋台店休，但 8/7（週五）抵達夜已先吃過一輪當保險；想吃中洲屋台天婦羅可找くすしゃん等攤。",
          arrive: {
            mode: "walk",
    ...
    },
    {
      ...
      returnNote: "歸途：西鐵柳川→二日市轉特急回西鐵福岡（天神）約 50 分（¥870，免特急料金），步行回 Cross Life。晚餐推薦『叙々苑 天神岩田屋本店新館 7F』高級燒肉（每人約 ¥10,000–16,000，人氣店務必先予約；想離飯店近也可選薬院・渡辺通『ヤキニク上』）。整段西鐵往返＋柳川川下り用「太宰府・柳川観光きっぷ」最划算。",
      bookLinks: [
      ...
      stops: [
        {
          ...
          arrive: {
            mode: "rail",
            text: "10:00 從 Cross Life 輕裝出發：步行至西鐵福岡（天神）約 10 分，西鐵急行至二日市轉太宰府線，門到門約 55–60 分。",
            legs: [
              { seg: "Cross Life→西鐵福岡（天神）", line: "步行", type: "徒步", min: 10, fare: 0 },
    ...
    },
    {
      ...
      stops: [
        {
          id: "d5-hotel", key: "nakasu", name: "Cross Life 博多天神（退房）",
          type: "hotel", time: "08:25", lat: 33.5878, lng: 130.4066,
          photo: "assets/img/nakasu.jpg",
          desc: "早餐＋退房。行李前一晚整理好；伴手禮已於 8/9 天神買齊，早上零採購壓力。四晚同一飯店、不換房，最後一早最從容。",
        ...
        },
        {
          ...
          arrive: {
            ...
            legs: [{ seg: "Cross Life→福岡空港 國際線", line: "計程車（GO／DiDi）", type: "計程車", min: 18, fare: 2600 }],
            fare: "約 ¥2,300–2,800（直達，可多人均攤）",
  ...
  const META = {
    ...
    home: { name: "Cross Life 博多天神", lat: 33.5878, lng: 130.4066 },
    premise: "20:00 抵 FUK、8/11 11:00 起飛。每天約 10:00 出發、不早起；不趕、大眾運輸、午後與室內為主。四晚同一飯店、不換房。",
    musts: ["皿倉山纜車夜景", "太宰府天滿宮", "一蘭總部 20:00 陽台演舞"],
    hotel: "四晚都住『Cross Life 博多天神』（ORIX 設計旅店、春吉那珂川南岸）：過河即中洲、步行到中洲屋台 4–5 分、一蘭 5–6 分、天神 7–10 分；男女大浴場＋三溫暖、福岡在地食材自助早餐。四晚不換房、北九州當日來回，行李零搬動。",
    designPoints: [
      { label: "日序鎖定", text: "皿倉山週六接駁巴士 → 北九州當日來回定 8/8；一蘭演舞＋屋台放在輕鬆的福岡室內日。" },
      { label: "省力動線", text: "四晚都住 Cross Life 博多天神、不換房；北九州（8/8）當日來回不過夜，行李零搬動、動線最單純。" },
      { label: "步調放慢", text: "每天約 10:00 才出發、不早起；午後與室內為主，8/9 不排 teamLab 最鬆、8/10 太宰府／柳川後以燒肉晚餐收尾。" },
      { label: "住宿亮點", text: "Cross Life 博多天神（春吉·那珂川南岸）四晚同一飯店：過河即中洲、步行到屋台/一蘭/天神都近，大浴場＋三溫暖、福岡食材早餐。" },
    ...
    budget: {
      ...
      rows: [
        ...
        { label: "住宿（4 晚 Cross Life · 2 人 1 室均攤）", val: "約 ¥48,000–64,000" },
        { label: "門票／體驗（皿倉山纜車 ¥1,230、柳川川下り ¥2,000、お守り等）", val: "約 ¥3,000–5,000" }
      ],
      total: "合計約 ¥80,000–110,000／人（≈ NT$17,000–23,000，不含機票）"
    }
  };
