...
(function () {
  ...
  const DAYS = [
    {
      ...
      summary: "晚間 20:00 抵福岡機場，計程車直達 Hotel Il Palazzo（春吉·中洲旁），落地第一碗拉麵後早早休息——隔天是全程最長的一天。",
      stops: [
        {
        ...
        {
          id: "d1-hotel", key: "nakasu", name: "Hotel Il Palazzo · 春吉",
          type: "hotel", time: "21:30", lat: 33.5887, lng: 130.4030,
          photo: "assets/img/nakasu.jpg",
          desc: "check-in、放行李。福岡三晚的基地：Aldo Rossi 設計的後現代名旅店，位於春吉、緊鄰中洲與那珂川（步行到一蘭／屋台 5–8 分），符合美術建築設計偏好。8/8 北九州一晚宿小倉，其餘三晚（8/7・8/9・8/10）都住這裡——全程只用兩間飯店、只為小倉打包一次。",
          arrive: { mode: "taxi", text: "計程車約 15–20 分（¥2,000–3,000）直達；省錢替代：免費接駁＋地鐵空港線約 8 分到中洲川端，再步行。" }
        },
        {
  ...
  const META = {
    ...
    hotel: "福岡三晚以 Hotel Il Palazzo（春吉·Aldo Rossi 設計旅店、中洲旁）為基地；8/8 北九州一晚宿小倉。全程只用兩間飯店、只為小倉打包一次。",
    designPoints: [
      ...
      { label: "住宿亮點", text: "Il Palazzo 設計旅店當福岡基地三晚、北九州一晚宿小倉，全程只用兩間飯店、僅為小倉打包一次。" },
