...
(function () {
    ...
    },
    {
      ...
      stops: [
        ...
        },
        {
          ...
          type: "sight", time: "09:50", lat: 33.9450, lng: 130.9614,
          photo: "assets/img/mojiko.jpg",
          desc: "1914 年木造、國家重要文化財現役車站。站內舊三等候車室改裝的星巴克可先吹冷氣。",
          arrive: { mode: "rail", text: "博多 → 門司港：JR 鹿兒島本線快速 直達約 1 小時 30 分（¥1,500）；求快可特急ソニック至小倉轉普通約 1 小時 15 分。直達班次少，出發前務必以乘換案內鎖定確切時刻。" }
        },
        {
          id: "d2-karato", key: "karato", name: "唐戶市場「活きいき馬関街」",
          type: "food", time: "10:40", lat: 33.9567, lng: 130.9459,
        ...
        },
        {
          ...
          type: "aquarium", time: "12:00", lat: 33.9546, lng: 130.9424,
        ...
        },
        {
          ...
          type: "sight", time: "14:30", lat: 33.9457, lng: 130.9626,
        ...
        },
        {
          ...
          type: "night", time: "17:45", lat: 33.8468, lng: 130.7971,
      ...
      stops: [
        {
          ...
          type: "cafe", time: "08:30", lat: 33.5196, lng: 130.5334,
        ...
        },
        {
          ...
          type: "museum", time: "09:30", lat: 33.5184, lng: 130.5383,
        ...
        },
        {
          ...
          type: "museum", time: "15:00", lat: 33.5839, lng: 130.3797,
  ...
  const META = {
    ...
    designPoints: [
      { label: "日序鎖定", text: "唐戶壽司限五六日、皿倉山週六接駁 → 北九州定 8/8；美術館週一休 → 看展排 8/9。" },
