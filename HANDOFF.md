...
## 3. 最終定案行程（Day1–5 逐點）— ★第四輪「四晚 Cross Life」定案
> 權威：網站資料在 `data.js`、簡報資料在 `data\planA.json`，**兩者已同步**。每天約 **10:00 出發**（Day1 晚間抵達、Day5 趕 11:00 班機需 08:30 出門，這兩天例外）。
> **住宿（定案）**：**四晚都住「Cross Life 博多天神」**（ORIX 設計旅店、福岡市中央区春吉、那珂川南岸；過河即中洲、步行到屋台 4–5 分／一蘭 5–6 分／天神 7–10 分；大浴場＋三溫暖、福岡食材早餐）、**不換房**。**北九州(8/8) 當日來回、不過夜**，行李零搬動。
> **沿革**：Day3／Day4 對調成省力動線、8/9 砍 teamLab、糸島整批不納入；**第四輪取消宿小倉/Il Palazzo，改四晚 Cross Life**。

**Day 1 · 8/7（五）抵達日**
- 20:00 福岡機場國際線（入境、領網卡）→ 計程車 → 21:30 **Cross Life 博多天神（春吉）** check-in（四晚都住這、不換房）→ 22:00 過那珂川到中洲覓食（一蘭總本店／屋台，週五屋台有開、先吃一輪當保險）。

**Day 2 · 8/8（六）北九州輕鬆日｜小倉散策＋皿倉山夜景（當日來回）**
- 10:00 從 Cross Life **輕裝**出發（當日來回）博多→**小倉**（新幹線~16分）→ 旦過市場、小倉城、有頂棚商店街 → 17:30 **皿倉山**（小倉→八幡 JR~13分＋接駁＋纜車；日落 19:12、新日本三大夜景；來回票 ¥1,230；山頂天宮開到 21:00）→ 下山搭 JR 回博多~1h（約 ¥860）→ **回 Cross Life**。
- 〔上一輪已拿掉門司港/唐戶/海響館；第四輪改為**當日來回、不過夜**。〕

**Day 3 · 8/9（日）福岡市內悠閒日｜天神購物＋一蘭演舞＋中洲屋台壓軸（不排 teamLab）**
- 10:00 **睡到自然醒**、從 Cross Life 步行/七隈線到天神（早餐可順博多駅前 **DACOMECCA**）→ 13:00 **shin shin 拉麵**（天神本店）→ 14:00 **天神購物**（岩田屋/三越/PARCO＋**天神地下街**＋**YOU+MORE!**；伴手禮今天買齊）→ 17:45 **Canal City**（運河夜噴泉＝「晚上博多運河」）→ 20:00 **一蘭本社陽台演舞**（中洲5-3-2，免費）→ 20:15 **中洲屋台**＋那珂川河畔 → 過河步行回 Cross Life。
- 〔原 Day4 內容移到這天、**砍 teamLab**、加 shin shin；屋台壓軸落在週日，部分攤週日休但 8/7 已先吃過。〕

**Day 4 · 8/10（一）太宰府＋竈門神社＋柳川｜古都與水鄉（輕裝）**
- 10:00 從 Cross Life **輕裝**出發（步行至西鐵福岡天神~10分）→ 11:00 **隈研吾星巴克**（太宰府表參道）→ 11:30 **太宰府天滿宮**（＋**天開稻荷神社**·彈性：後山紅鳥居、來回~30分，腳力夠再上）→ 12:15 **宝満宮竈門神社**（まほろば号~10分 ¥100）→ 15:00 **柳川 どんこ舟川下り**＋**若松屋**鰻魚せいろ蒸し（沖端百年名店）→ 17:00 柳川→天神 **敘敘苑燒肉**（岩田屋7F；或薬院「ヤキニク上」）→ 回 Cross Life。
- 〔原 Day3 內容移到這天、加若松屋/天開稻荷/敘敘苑；行李已在福岡、不帶往南。建議買「太宰府・柳川観光きっぷ」。〕

**Day 5 · 8/11（二）回程日**
- 08:25 Cross Life 博多天神 退房 → 計程車直達國際線 → 08:55 機場報到 → 11:00 起飛。
