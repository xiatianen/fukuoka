...
- **狀態**：
  ...
  - ✅ 行程在這一輪做過大改（見 §3）：Day2 改小倉、Day3 加竈門神社+柳川、每天 10:00 出發。
...
**Day 1 · 8/7（五）抵達日**
- 20:00 福岡機場國際線（入境、領網卡）→ 計程車 → 21:30 中洲川端飯店 check-in → 22:00 中洲覓食（一蘭總本店／屋台）。

**Day 2 · 8/8（六）北九州輕鬆日｜小倉散策＋皿倉山夜景**
- 10:00 福岡市內悠閒上午 → 12:30 **小倉**（博多→小倉新幹線~16分；旦過市場、小倉城、有頂棚商店街）→ 17:30 **皿倉山**（小倉→八幡 JR~13分＋接駁＋纜車；日落 19:12、新日本三大夜景；來回票 ¥1,230）→ 八幡→博多~1h 回飯店。
- 〔本日是上一輪的大改：**拿掉了門司港、唐戶市場、海響館**（不再跨海到下關）。〕

**Day 3 · 8/9（日）太宰府＋竈門神社＋柳川｜古都與水鄉**
- 10:00 出發 → 11:00 **隈研吾星巴克**（太宰府表參道）→ 11:30 **太宰府天滿宮** → 12:30 **宝満宮竈門神社**（太宰府駅前社區巴士「まほろば号」~10分 ¥100）→ 15:00 **柳川 どんこ舟川下り**（太宰府→二日市→西鐵柳川~50–60分；撐篙遊水道~70分 ¥1,800、名物鰻魚せいろ蒸し）→ 柳川→天神 回飯店。
- 〔本日大改：**加了竈門神社＋柳川**，**拿掉了九州國立博物館、福岡市美術館、大濠公園**。建議買「太宰府・柳川観光きっぷ」。〕

**Day 4 · 8/10（一）全室內購物日＋teamLab｜一蘭演舞＋屋台壓軸**
- 10:00 出發 → 11:00 **teamLab Forest／BOSS E・ZO** → 14:00 **天神購物**（岩田屋/三越/PARCO；伴手禮今天買齊）→ 17:45 **Canal City**（運河噴泉）→ 20:00 **一蘭本社陽台演舞**（中洲5-3-2，免費）→ 20:15 **中洲屋台**（週一有開）。

**Day 5 · 8/11（二）回程日**
- 08:25 退房 → 計程車直達國際線 → 08:55 機場報到 → 11:00 起飛。
