...
> **住宿**：8/7 抵達夜住 **中洲川端一般飯店**（首選 ザ ロイヤルパーク キャンバス 福岡中洲）；**8/8 北九州一晚宿小倉**；**8/9–8/10 入住 Hotel Il Palazzo（春吉·Aldo Rossi 設計、中洲旁）**，演舞屋台夜散步回房最近。luggage 流：中洲→小倉→Il Palazzo，不帶行李往南（**不寄宅急便、不付空房**）。
> **第二輪兩大改**：① **Day3／Day4 對調**成省力動線（見下）；② **8/9 砍掉 teamLab**，更悠閒。**糸島**（芥屋大門/花鹽布丁/糸島海鮮堂）整批不納入。

**Day 1 · 8/7（五）抵達日**
- 20:00 福岡機場國際線（入境、領網卡）→ 計程車 → 21:30 **中洲川端一般飯店** check-in（8/9–8/10 才改住 Hotel Il Palazzo）→ 22:00 中洲覓食（一蘭總本店／屋台，週五屋台有開、先吃一輪當保險）。
